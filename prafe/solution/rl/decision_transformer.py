from prafe.solution.rl.layer import *


class DecisionTransformer(nn.Module):
    
    def __init__(self, state_dim, act_dim, n_blocks, h_dim, context_len,
                 n_heads, drop_p, max_timestep=4096, is_continuos_action=True):
        super().__init__()
        ...
        use_action_tanh = is_continuos_action # True for continuous actions, False for discreate actions
